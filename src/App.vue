...
<template>
  <div
    class="container max-w-screen-sm mx-auto p-3 px-10 grid grid-cols-2 items-baseline border-b-4 rounded border-green-400"
  >
    ...
    <nav class="justify-self-end">
      <Menu as="div" class="relative">
        ...
        >
          <MenuItems
            as="ul"
            class="absolute right-0 p-5 mt-1.5 w-max min-w-32 flex flex-col rounded shadow bg-white"
          >
            <MenuItem>
