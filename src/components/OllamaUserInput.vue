...
<template>
  <div
    class="overflow-hidden flex flex-col flex-grow w-full relative border rounded-2xl focus-within:border-black focus-within:shadow"
  >
    <textarea
      id="prompt-textarea"
      tabindex="0"
    ...
    ></textarea>
    <div class="absolute bottom-1/2 transform translate-y-1/2 left-2 md:left-4">
      <div class="flex">
        <button
